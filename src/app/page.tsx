          ...
          <div className="container">
            ...
            <div className={styles.partnersGrid}>
              <a href="https://openai.com" target="_blank" rel="noopener noreferrer" className={styles.partnerLogo}>
                ...
                <img src="https://cdn.simpleicons.org/openai/606878" width="80" height="80" alt="OpenAI logo" loading="lazy" />
              ...
              <a href="https://mistral.ai" target="_blank" rel="noopener noreferrer" className={styles.partnerLogo}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://cdn.simpleicons.org/mistral/606878" width="80" height="80" alt="Mistral logo" loading="lazy" />
